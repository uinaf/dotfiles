...
test("matches Cursor's project directory slug", () => {
  assert.equal(
    cursorProjectSlug("/Users/dev/projects/acme/dotfiles"),
    "Users-dev-projects-acme-dotfiles",
  );
  assert.equal(
    cursorProjectSlug("/Users/dev/projects/acme/site.example"),
    "Users-dev-projects-acme-site-dot-example",
  );
