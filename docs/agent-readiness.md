...
| Testable | pass | `scripts/verify/repo.sh` runs shell syntax, ShellCheck, the isolated Git bootstrap contract, Actionlint, diff hygiene, agent-entrypoint checks, and repo secret scans. | Live bootstrap checks require a matching personal or devbox Mac. |
