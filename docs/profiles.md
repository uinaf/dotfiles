...
The same developer layer installs the autoreview and slopomatic CLIs from
`uinaf/tap`. Their install flow also syncs machine-global instructions and
additive skills from `scripts/agents/`; see
