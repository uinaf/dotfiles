...
The personal profile manages Zed settings. Personal, personal-devbox,
workstation, and devbox profiles share GitHub authentication, outbound SSH, signing-helper,
