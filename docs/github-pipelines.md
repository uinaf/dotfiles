...
| --- | --- | --- |
| Verify | Push to `main`, pull request, manual dispatch | Run `./scripts/verify/repo.sh --skip-security` on macOS. Successful pushes to `main` continue to release evaluation. |
